...
print("para personalizar tu cuenta, por favor responde las siguientes preguntas:" )
peli = input("¿Cúal es tu película favorita?")
hob = input("¿Cuál es tu hobbie?")
col = input("¿Cuál es tu color favorito?")